<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\phpstudy_pro\WWW\public/../application/admin\view\kaoshi\examination\questions\add.html";i:1604814583;s:62:"D:\phpstudy_pro\WWW\application\admin\view\layout\default.html";i:1602168705;s:59:"D:\phpstudy_pro\WWW\application\admin\view\common\meta.html";i:1602168705;s:61:"D:\phpstudy_pro\WWW\application\admin\view\common\script.html";i:1602168705;}*/ ?>
<!DOCTYPE html>
...
<form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-question" data-rule="required" class="form-control editor" rows="5" name="row[question]" cols="50"></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <dl    data-template="answer<?php echo $k; ?>" class="fieldlist fieldlist<?php echo $k; ?> <?php echo $k!=0?'hidden' : ''; ?>" data-name="row[selectdata<?php echo $k; ?>]" data-listidx="0">
                ...
                <dd class="form-inline">
                    ...
                    <ins><input type="radio" name="row[answer<?php echo $k; ?>]" value="<?php echo $option['key']; ?>"  /></ins>
                    <!--下面的两个按钮务必保留-->
                    <?php if($k != '2'): ?>
